...
def test_drone_api_client_get_build_with_failed_stages(context):
    ...
    failed_stage_names.should.equal(['test', 'build', 'acceptance_tests', 'performance_test', 'pre_deployment_check', 'deployment', 'post_deployment_check', 'metrics'])
...
def test_drone_api_client_get_latest_build_with_log(context):
    ...
    failed_steps.should.have.length_of(0)
