...
def upgrade():
    op.create_table(
        ...
        db.Column("github_username", db.Unicode(255), index=True),
        db.Column("github_email", db.Unicode(255), index=True),
        db.Column("github_access_token", db.UnicodeText, index=True),
        db.Column("github_refresh_token", db.UnicodeText, index=True),
        db.Column("github_json", db.UnicodeText),
        db.Column("slack_username", db.Unicode(255), index=True),
        db.Column("slack_email", db.Unicode(255), index=True),
        db.Column("slack_access_token", db.UnicodeText, index=True),
        db.Column("slack_refresh_token", db.UnicodeText, index=True),
